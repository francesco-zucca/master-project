...
This high degree of correlation suggests that the spatial distribution of Mexican migrants across U.S. states has remained highly stable over time, lending credibility to our use of an averaged weighting matrix for estimating bilateral remittance flows. Given that Hurricane Ian hit florida in Q4 2022 and the MCAS data for Florida in 2013 is missing, to construct our treatment variable we use the average of the weighting matrices from \textcolor{red}{at the end we used the covid years to construct the average? @ zucca }2014 to 2021, which are all highly correlated with each other, and avoid any endogeneity in the treatment caused by the shock.
